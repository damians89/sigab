...
@if(  $dataTypeContent->{$row->field}  ==1)
 <span class="badge badge-lg" style="background-color: red">
 Habilitada</span>
@else ( $dataTypeContent->{$row->field} == 0)

 <span class="badge badge-lg" style="background-color: {{ $data->{$row->field} }}">No habilitada </span>
 @endif
