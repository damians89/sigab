...
class BecasController extends VoyagerBaseController
{
    ...
    public function create(Request $request)
    {
       ...
       $slug = $this->getSlug($request);
        ...
        $calculos=db::table('calculos_aux')->get();
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','calculos'));
    }
